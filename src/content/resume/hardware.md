...
Smart Factory · AI-driven Manufacturing · Physical AI 영역에서는 하드웨어 도메인 이해와
현대 백엔드 아키텍처 역량이 모두 필요합니다. 저는 4년간 대량생산 라인에서 협력사·유관부서와
조율하며 공정 이슈를 해결해 본 경험과, 이후 4년간의 이벤트 드리븐/CDC 기반 백엔드 설계 경험을
같은 사람의 이력으로 가지고 있습니다.
